...
class SpeechTokenExtractor():
    def __init__(self, model_path):
        ...
        # NOTE: CUDAExecutionProvider was found to destabilize training under WSL2's virtualized GPU
        # (cuDNN/CUDA context contention with PyTorch's own CUDA allocations caused intermittent
        # CUDNN_STATUS_INTERNAL_ERROR / CUDA failure 999 crashes). CPU inference for this lightweight
        # tokenizer network is stable and fast enough for online per-batch use.
